...
broken line";
		...
		{
			var str = @"2";
			Assert.AreEqual (1, str.Length, "'True art selects and paraphrases, but seldom gives a verbatim translation.' - Thomas Bailey Aldrich");
		}
		...
		public void ConvertTheCaseToMakeComparisonSoThatCaseDoesNotMatter ()
		{
            ...
            Assert.AreEqual("UNITED STATES OF AMERICA", strUpper, "How can you argue with something in ALL CAPS? Someone took the time to press the shift key..");
		}
